<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $q = "UPDATE users SET id=$id, title='$title', details='$details', date='$date' WHERE id=$id";
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form action="" method="POST" onsubmit="return todoVal()">
                    <h1 class="text-muted text-center m-4">Update ToDo List</h1>
                    <div class="mb-3">
                        <label for="title" class="form-label">Title:</label>
                        <input type="text" class="form-control" id="title" 
                        value=""name="title" onblur="checkValue(this)" 
                    ...
                    <div class="mb-3">
                        ...
                        onblur="checkValue(this)" placeholder="Input your detais here..."></textarea>
                        <span id="details_error" style="color:red;"></span>
                    </div>
                    <div class="mb-3">
                        <label for="date" class="form-label">Date:</label>
                        <input type="date" class="form-control" value="" id="date" name="date" onblur="checkValue(this)" placeholder="Input your date here">
                        <span id="date_error" style="color:red;"></span>
                    </div>
                    <button type="submit" id="submit" class="btn btn-primary" name="submit" onsubmit="todoVal();">Update</button>
                </form>
            </div>
            <div class="col-md-6">
